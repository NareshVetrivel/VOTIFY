                ...
                button.addEventListener(
                    ...
                    () => {
                        ...
                        selectedCandidate = {
                            ...
                            manifesto: button.dataset.manifesto
                        ...
                        showSuccessToast(
                            ...
                            selectedCandidate.name + " selected successfully."
...
function goToCandidateConfirmation() {
    ...
    ).textContent = selectedCandidate.name;

    document.getElementById(
        "confirmationCandidateDepartment"
    ).textContent = selectedCandidate.department;

    document.getElementById(
        "confirmationCandidateYear"
    ).textContent = selectedCandidate.year;

    document.getElementById(
        "confirmationCandidateManifesto"
    ).textContent = selectedCandidate.manifesto;
    ...
    if (selectedCandidate.id === "NOTA") {
        ...
        photo.src = "../../assets/images/nota.png";
