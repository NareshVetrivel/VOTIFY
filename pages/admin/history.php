...
if ($result) {
    ...
    $todayLogs = mysqli_fetch_assoc($result)["total"];
...
if ($result) {
    ...
    $adminActions = mysqli_fetch_assoc($result)["total"];
...
if ($result) {
    ...
    $securityEvents = mysqli_fetch_assoc($result)["total"];
...
<?php echo $totalLogs; ?>
            ...
            class="w-16 h-16 rounded-2xl bg-blue-500/20 flex items-center justify-center">
                ...
                <i
                class="ri-file-list-3-line text-3xl text-blue-400">
    ...
    <div class="glass rounded-3xl p-6 dashboard-card">
        ...
        <div class="flex items-center justify-between">
            ...
            class="w-16 h-16 rounded-2xl bg-yellow-500/20 flex items-center justify-center">
                ...
                <i
                class="ri-calendar-check-line text-3xl text-yellow-400">
    ...
    <div class="glass rounded-3xl p-6 dashboard-card">
        ...
        <div class="flex items-center justify-between">
            ...
            class="w-16 h-16 rounded-2xl bg-green-500/20 flex items-center justify-center">
                ...
                <i
                class="ri-user-settings-line text-3xl text-green-400">
    ...
    <div class="glass rounded-3xl p-6 dashboard-card">
        ...
        <div class="flex items-center justify-between">
            ...
            <div
            class="w-16 h-16 rounded-2xl bg-red-500/20 flex items-center justify-center">

                <i
                class="ri-shield-check-line text-3xl text-red-400">
...
<div class="glass rounded-3xl p-8">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
        ...
        <div class="relative w-full lg:w-80">
            ...
            <i
            class="ri-search-line absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
            </i>
    ...
    <div class="flex flex-col md:flex-row justify-between gap-4 mb-6">
        ...
        class="w-56">
            ...
            <option>Election Started</option>
            <option>Election Stopped</option>
            <option>Student Approved</option>
            <option>Candidate Added</option>
