...
>
    ...
    >
        ...
        <div
            class="absolute top-0 left-0 w-96 h-96 bg-blue-600/20 blur-[140px] rounded-full"
        ></div>
        ...
        <div
            class="absolute top-1/2 left-1/2 w-80 h-80 bg-purple-600/20 blur-[120px] rounded-full -translate-x-1/2 -translate-y-1/2"
        ></div>
    ...
    <section class="flex-1 py-14">
        ...
        <div class="max-w-5xl mx-auto px-6">
            ...
            <div class="text-center mb-10">
                ...
                <h1
                    class="mt-6 text-4xl md:text-5xl font-bold"
                >
            ...
            <div
                class="glass rounded-3xl p-8 md:p-10 shadow-2xl"
            >
                ...
                >
                    ...
                    <div class="mb-6">
                        ...
                        <input
                            ...
                            class="w-full h-14 px-5 rounded-xl bg-white/5 border border-white/10 text-white placeholder:text-slate-500 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 outline-none transition-all uppercase"
                            required
                        >
                    ...
                    <div class="lg:col-span-2 mb-2">
                        ...
                        <label
                            class="block mb-4 font-medium text-slate-300"
                        >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <i
                                        class="ri-men-line text-xl text-blue-400"
                                    ></i>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <i
                                        class="ri-women-line text-xl text-pink-400"
                                    ></i>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <i
                                        class="ri-user-3-line text-xl text-purple-400"
                                    ></i>
    ...
    <div
        id="successToast"
        class="fixed top-6 right-6 translate-x-[120%] transition-all duration-500 bg-green-600 text-white px-6 py-4 rounded-xl shadow-2xl z-[9999]"
    >
